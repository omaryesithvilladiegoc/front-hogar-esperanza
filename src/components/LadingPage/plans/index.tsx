            ...
            return (
              ...
              >
                <div
                  style={{
                    height: "100%",
                    background: `linear-gradient(to top, rgba(32, 180, 125, 0.8) 0%, rgba(0, 128, 0, 0) 100%), url(${plan?.url as string})`,
                    width: "90%",
                    margin: "0 auto",
                    borderRadius: "20px",
                    overflow: "hidden",
                  ...
                  >
                    <div
                      style={{
                        ...
                        overflow: "hidden",
                        background: matches
                          ? "linear-gradient(-90deg, rgba(5,162,107,255) 95%, rgba(0,212,255,0) 100%)"
                          : "linear-gradient(-90deg, rgba(5,162,107,0.5) 95%, rgba(0,212,255,0) 100%)",
                      }}
                    >
                      <div
                        style={{
        ...
        {programs.map((plan, index) => {
          return (
            ...
            >
              ...
              >
                <h2 style={{ zIndex: 1 }} className={fontRoboto.className}>
                  {" "}
                  {plan?.nombre}{" "}
                </h2>
              </Stack>
