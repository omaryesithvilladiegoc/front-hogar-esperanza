    ...
    <Container maxWidth="md">
      ...
      >
        ...
        <Typography variant="body1" align="justify" gutterBottom>
          ...
          <strong> Fundación Hogar Esperanza</strong>, resulta necesario recopilar 
          determinada información personal. Fundación Hogar Esperanza será 
          responsable de recabar sus datos personales, del uso que se les dé y de 
          su protección.
        </Typography>
        ...
        <Typography variant="body1" align="justify" gutterBottom>
          Fundación Hogar Esperanza tiene su domicilio en Calle [Nombre y Número],
          Colonia [Colonia], [Municipio o Alcaldía], [Estado], Código Postal [Código Postal].
        </Typography>
        <Typography variant="h6" component="h2" gutterBottom>
