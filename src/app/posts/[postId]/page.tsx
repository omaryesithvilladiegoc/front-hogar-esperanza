  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content={postFound?.subtitle || "Description is missing!"} />
        <meta name="keywords" content={postFound?.keywords?.join(", ") || "Keywords are missing!"} />
      ...
      >
        ...
        <Grid container justifyContent={"center"} spacing={2}>
          ...
          <Grid size={10}>
            ...
            <Typography variant="h3" style={{lineHeight:1.1, fontSize: "clamp(1.25rem, 2vw, 2.5rem"}}>
              {postFound?.header}
            </Typography>
